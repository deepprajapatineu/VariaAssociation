...
// import DetailScreen from './screens/profilescreens/DetailScreen';
...
import RootWeddingScreen from './screens/RootWeddingScreen';
  ...
  const authContext = React.useMemo(() => ({
    ...
    signOut: async() => {
      ...
      try {
        ...
        await AsyncStorage.removeItem('middleName');
        await AsyncStorage.removeItem('lastName');
        await AsyncStorage.removeItem('mobileNumber');
        await AsyncStorage.removeItem('dpuri');
        await AsyncStorage.removeItem('dpuri2');
      } catch(e) {
        console.log(e);
      }
    ...
    <NavigationContainer theme={theme}>
      { loginState.userToken !== null ? (
        <Drawer.Navigator drawerContent={props => <DrawerContent {...props} />}>
          ...
          <Drawer.Screen name="Home" component={RootHomeScreen} 
          options={{
        headerLeft: () => (
        ...
        />         
          <Drawer.Screen name="SettingsScreen" component={RootProfileScreen} />
...
export default App;
 ...
 {/* <RootProfile.Navigator >
        <RootProfile.Screen name="DetailScreen" component={DetailScreen}/>
        <RootProfile.Screen name="ChangePasswordScreen" component={ChangePasswordScreen}/>
